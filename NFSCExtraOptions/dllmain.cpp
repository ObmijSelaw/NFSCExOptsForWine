...
void Init()
{
    ...
    CrewMemberInAnyRace = iniReader.ReadInteger("Menu", "CrewMemberInAnyRace", 0) == 1;
    CanyonAIUnlimiter = iniReader.ReadInteger("Menu", "CanyonAIUnlimiter", 0) == 1;
    ...
    UnlockAllThings = iniReader.ReadInteger("Gameplay", "UnlockAllThings", 0);
    ...
    injector::MakeRangedNOP(0x5B729E, 0x5B72A0, true);
    // Let user create a new save game instead of showing "Too many saves" dialog.
